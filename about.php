...
<div class="super_container">
	...
	<div class="find">
		...
		<div class="container">
			<div class="row">
				<div class="col-12">
					<div class="find_title text-center">Find a stopage of any Aub Nilbus</div>
				</div>
				<div class="col-12">
			...
			<div class="row about_row">
				<div class="col-lg-6 about_col order-lg-1 order-2">
					<div class="about_content">
						<p>
							Introducing ourselves. Shamim Ehasan (image on just aside),Asian University of Bangladesh.
							Department of Computer Science Engineering.<br>
							Abdullah Reza(image just below of Imon),Asian University of Bangladesh, Department of Computer Science Engineering.
							We are both of 2015-19 session.
						</p>
