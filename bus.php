...
<div class="super_container">
								...
								<li class="main_nav_item active">
									<div class="dropdown">
										...
										<div class="dropdown-content">
											...
											<a href="#">Aub bus 8</a>
											<a href="#">Aub bus 9</a>
											<a href="#">Aub bus red</a>
											<a href="#">Aub bus green</a>
											<a href="#">Aub bus blue</a>
										</div>
									</div>
								</li>
	...
	<div class="home">
		<div class="home_background" style="background-image:url(images/Nilbus.jpg)"></div>
			...
			<div class="row">
				...
				<div class="col-lg-4 footer_col">
					<div class="footer_about">
						...
						<div class="footer_about_text">we are a little travel group of Aub.we offer all students travelling around the world at ours specials offers.</div>
						<div class="copyright"><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank"> Shamim & abdullah</a>
